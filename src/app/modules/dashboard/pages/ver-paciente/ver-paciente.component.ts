...
import { Examenes, Antecedentes, Responsable, Paciente } from 'src/app/modules/pacientes/models/historia-clinica.interface';
import { PacientesService } from 'src/app/modules/pacientes/services/pacientes.service';
